                                    ...
                                    <form action="{{ route('admin.update.paper') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <textarea style="color: white" class="form-control form-control-sm" name="description" placeholder="Write your message"
                                                    required> <span style="color: white"> {{ $paper->description }}</span></textarea>
                                            </div>
                                        </div>
